			...
			<div class="row w_main_row">
				...
				<div class="focusbox">
					<div class="contentbox">
						<ul class="contentimg">
							<li><a href="#" ><img width="990" height="340" src="../public/static/img/sight1.jpg"></a></li>
							<li><a href="#" ><img width="990" height="340" src="../public/static/img/sight2.jpg"></a></li>
							<li><a href="#" ><img width="990" height="340" src="../public/static/img/sight3.jpg"></a></li>
							<li><a href="#" ><img width="990" height="340" src="../public/static/img/sight4.jpg"></a></li>
							<li><a href="#" ><img width="990" height="340" src="../public/static/img/sight5.jpg"></a></li>
							<li><a href="#" ><img width="990" height="340" src="../public/static/img/sight6.jpg"></a></li>
							<li><a href="#" ><img width="990" height="340" src="../public/static/img/sight7.jpg"></a></li>
						</ul>
					</div>

					<div class="navbox">
						<ul class="mfoc_nav">
							<li _index="1" class="selected"><img width="137" height="53" src="../public/static/img/sight1.jpg"/></li>
							<li _index="2"><img width="137" height="53" src="../public/static/img/sight2.jpg"/></li>
							<li _index="3"><img width="137" height="53" src="../public/static/img/sight3.jpg"/></li>
							<li _index="4"><img width="137" height="53" src="../public/static/img/sight4.jpg"/></li>
							<li _index="5"><img width="137" height="53" src="../public/static/img/sight5.jpg"/></li>
							<li _index="6"><img width="137" height="53" src="../public/static/img/sight6.jpg"/></li>
							<li _index="7"><img width="137" height="53" src="../public/static/img/sight7.jpg"/></li>
						</ul>
					</div>
