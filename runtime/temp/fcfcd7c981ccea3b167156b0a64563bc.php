<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:78:"D:\webs\lymloook.com\public/../application/blog\view\v1\register\register.html";i:1554964296;}*/ ?>
<!doctype html>
<html lang="en">
    <head>
        <meta charset="UTF-8">
    ...
    <script type="text/javascript">
        ...
        if(ajaxmockjax == 1){
            $.mockjax({
                ...
                status: 200,
                responseTime: 50,
                responseText: {"Status":"ok","Text":"注册成功<br /><br />立即登录 <br /><br /> <a href='blog' style='font-size: large'>返回</a>"}
            });
            $.mockjax({
                url: 'Ajax/LoginFalse',
                status: 200,
