<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:72:"D:\webs\lymloook.com\public/../application/blog\view\v1\login\login.html";i:1554964296;}*/ ?>
<!doctype html>
<html lang="en">
  <head>
    <meta charset="UTF-8">
  ...
  <script type="text/javascript">
    ...
    if(ajaxmockjax == 1){
      $.mockjax({
        ...
        status: 200,
        responseTime: 50,
        responseText: {"Status":"ok","Text":"登陆成功<br /><br />欢迎回来 <br /><br /> <a href='blog' style='font-size: large'>返回</a>"}
      });
      $.mockjax({
        url: 'Ajax/LoginFalse',
        status: 200,
